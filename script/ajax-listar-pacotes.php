...
$query = $pdo->query("SELECT * FROM pacotes WHERE nome LIKE '$busca' or desc_rapida LIKE '$busca' ORDER BY id desc LIMIT $limite, $itens_pag"); //LIMIT vai de limit à itens_pag
...
HTML;
  ...
  echo '<br><p align="center">Não possui nenhum pacote com este nome!</p>';
}
