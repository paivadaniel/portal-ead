		...
		<div class="col-md-2" style="margin-top:5px;" align="center">
			<div>
				<small>
					...
					<a title="Movimentações de Hoje" class="text-muted" href="#" onclick="valorData('<?php echo $data_hoje ?>', '<?php echo $data_hoje ?>')"><span>Hoje</span></a> /
					<a title="Movimentações do Mês" class="text-muted" href="#" onclick="valorData('<?php echo $data_mes ?>', '<?php echo $data_hoje ?>') //vai da data_mes, que o usuário escolhe até data de hoje)"><span>Mês</span></a>
				</small>
			</div>
		</div>
