...
HTML;
    ...
    <tr class="{$classe_linha}">
        ...
        <img src="img/login/{$foto}" width="27px" class="me-2">
        {$nome}</td> <!-- repare que <?php echo $nome ?> é substituído aqui por {$nome}-->
...
<script type="text/javascript">
    ...
    function editar(id, nome, link, foto) {
        ...
        $('#target').attr('src', 'img/login/' + foto); //mostra imagem da foto
