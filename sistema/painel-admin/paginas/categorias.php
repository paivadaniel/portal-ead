			...
			<form method="post" id="form">
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div id="divImg">
								<img src="img/categorias/sem-foto.png" width="100px" id="target"><!-- não é src="../img/perfil/sem-perfil.jpg", pois alunos.php é chamado dentro de painel-admin/index.php  -->
							</div>
						</div>
