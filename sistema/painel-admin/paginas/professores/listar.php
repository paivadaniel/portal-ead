...
HTML;
    ...
    <tr class="{$classe_linha}">
		...
		<big><a href="#" onclick="mostrar('{$nome}', '{$cpf}','{$email}','{$telefone}', '{$foto}', '{$dataF}', '{$ativo}', '{$senha_usuario}')" title="Ver Dados"><i class="fa fa-info-circle text-secondary"></i></a></big>
...
<script type="text/javascript">
    ...
    function mostrar(nome, cpf, email, telefone, foto, data, ativo, senha) {
