            ...
            <form method="post" id="form">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Título <small> (Máx. 50 caracteres) </small></label>
                                <input maxlength="50" type="text" class="form-control" name="titulo" id="titulo" required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Descrição <small> (Máx. 160 caracteres) </small></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Foto <small>(Tamanho recomendado 940x627px)</small></label>
                                <input class="form-control" type="file" name="foto" onChange="carregarImg();" id="foto">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div id="divImg">
                                <img src="img/banners/sem-foto.png" width="100%" id="target"><!-- não é src="../img/perfil/sem-perfil.jpg", pois alunos.php é chamado dentro de painel-admin/index.php  -->
                            </div>
                        </div>
