...
if ($total_reg > 0) {
    ...
    //próxima aula
    if ($anterior_proxima_atual_aula == 'proximo' and $sessao == 0) { //curso sem sessão
    ...
    } else if ($anterior_proxima_atual_aula == 'proximo' and $sessao != 0) { //curso com sessão
...
*/
    ...
    } else if ($anterior_proxima_atual_aula == 'anterior' and $sequencia_aula > 1 and $sessao != 0) {
